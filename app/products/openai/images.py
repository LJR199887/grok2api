...
async def _resolve_image_output(
    *,
    ...
    use_imgbed = fmt == "url" and is_imgbed_enabled()
    if fmt == "url" and not use_imgbed and not _app_url():
    ...
    if use_imgbed:
        ...
        return _ImageOutput(api_value=public_url, markdown_value=f"![image]({public_url})")
